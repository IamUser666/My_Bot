...
# TODO: Вставьте сюда ваш токен бота
API_TOKEN = "7038015719:AAHJKfOcShdeX0ZnodoDNqkFcc2Th4psdgQ"
# Укажите ваш пользовательский Telegram user_id для получения file_id
MY_USER_ID = 5698110214  # Замените на ваш реальный user_id
